...
<div class="card shadow-sm">
    ...
    <div class="card-body">
                ...
                <tbody>
                    ...
                    @foreach($groupedItems as $category => $items)
                        ...
                        @foreach($items as $item)
                            @php
                                $categoryTotalKL += ($item['region'] === 'Kuala Lumpur') ? $item['quantity'] : 0;
                                $categoryTotalCyber += ($item['region'] === 'Cyberjaya') ? $item['quantity'] : 0;
        ...
        <div>
            ⚠️ <strong>You don't have permission to view the rate card.</strong>
        </div>
</div>
        @endif
    ...
    <i class="bi bi-download"></i> Download Rate Card
                ...
                <!--<a href="{{ url('versions/' . $version->id . '/generate-mpdraas-pdf') }}" class="btn btn-pink me-2">
                    <i class="bi bi-download"></i> Download MP-DRaaS Rate Card
                </a>--->
