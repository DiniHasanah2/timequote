  ...
  <div class="d-flex flex-column align-items-centre gap-2">
            ...
            <div class="d-flex justify-content-end gap-3"> 
                <button type="submit" class="btn btn-pink"  @disabled($isLocked)>Save Time Security Service</button>
                  ...
                  <a href="{{ route('versions.non_standard_offerings.create', $version->id) }}" class="btn btn-secondary me-2" role="button">Next: Standard Services<i class="bi bi-arrow-right"></i></a>
