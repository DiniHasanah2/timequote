...
@if(($mode ?? 'monthly') === 'monthly')
    <td rowspan="2" style="font-weight: bold; background: #f0f0f0; padding: 5px;">Monthly Commitment<br>(Exclude SST):</td>
...
<a href="{{ route('versions.quotation.download_table_pdf', $version->id) }}?mode=monthly" class="btn btn-pink">
